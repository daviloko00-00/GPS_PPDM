...
const menuOptions = [
    {
        title: 'Posição Geografica',
        description: 'Consulte a localização utilizando GPS',
        ...
        <SafeAreaView style={styles.safeArea}>
            <View style={styles.container}>
                <View style={styles.heading}>
                    <Text style={styles.eyebrow}>RECURSOS DE DISPOSITIVOS</Text>
                    <Text style={styles.title}>ESCOLHA UMA FERRAMENTA</Text>
                    <Text style={styles.subtitle}>Explore sensores e ferramentas do seu aparelho</Text>
